...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        groupBox->setGeometry(QRect(10, 10, 491, 231));
        image_label = new QLabel(groupBox);
        image_label->setObjectName(QStringLiteral("image_label"));
        image_label->setGeometry(QRect(10, 30, 461, 171));
        groupBox_2 = new QGroupBox(centralWidget);
        groupBox_2->setObjectName(QStringLiteral("groupBox_2"));
        groupBox_2->setGeometry(QRect(10, 250, 751, 211));
        ...
        pushButton->setGeometry(QRect(540, 20, 93, 28));
        pushButton_2 = new QPushButton(centralWidget);
        pushButton_2->setObjectName(QStringLiteral("pushButton_2"));
        pushButton_2->setGeometry(QRect(540, 210, 93, 28));
